...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/onboarding/onboarding-adapter.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
const STEP_ORDER = [Steps.WELCOME, Steps.AUTH, Steps.PERMISSIONS, Steps.ACCOUNT_SETUP, Steps.EMAIL_SETUP, Steps.UI_CUSTOMIZATION, Steps.COMPANION_CONFIG, Steps.COMPLETE];
...
function buildNextAction(progress) {
  const stepMeta = {
    ...
    [Steps.AUTH]: {
      ...
      action: 'Authenticate with OAuth or email/password',
      route: '/auth/login'
    },
    [Steps.PERMISSIONS]: {
      title: 'Configure Permissions',
      action: 'Set access levels',
    ...
    return res.json(success({
      ...
      headybuddyIntro: {
        ...
        features: [{
          ...
          icon: 'zap',
          label: 'HeadySwarm',
          description: 'Fibonacci-allocated worker swarms'
        }, {
          icon: 'heart',
          label: 'Open Source',
...
router.get('/templates', (req, res) => {
  const templates = [{
    ...
    name: 'Heady Lite',
    description: 'Clean, minimal dashboard',
    category: 'minimal',
    recommendedTiers: ['free', 'pro'],
    recommendedRoles: ['developer', 'designer']
  }, {
    id: 'heady-enterprise-pro',
    name: 'Enterprise Pro',
    description: 'Full-featured enterprise dashboard',
    category: 'enterprise',
    recommendedTiers: ['pro', 'enterprise'],
    recommendedRoles: ['admin', 'ops']
  }, {
    id: 'heady-sacred-geometry',
    name: 'Sacred Geometry',
    description: 'Phi-optimised sacred geometry layout',
    category: 'creative',
    recommendedTiers: ['free', 'pro', 'enterprise'],
    recommendedRoles: ['developer', 'creative']
  }, {
    id: 'heady-command-center',
    name: 'Command Center',
    description: 'Operations and monitoring focus',
    category: 'ops',
    recommendedTiers: ['pro', 'enterprise'],
    recommendedRoles: ['ops', 'admin']
  }];
  res.json(success({
    templates,
