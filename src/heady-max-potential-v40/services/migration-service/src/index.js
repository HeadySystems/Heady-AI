...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/heady-max-potential-v40/services/migration-service/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
const HEALTH_PORT = parseInt(process.env.PORT || '4020', 10);
let migrationState = { status: 'idle', lastRun: null, error: null };

function setMigrationState(state) {
  migrationState = { ...migrationState, ...state, updatedAt: Date.now() };
}

const healthServer = createServer((req, res) => {
  if (req.url === '/health' && req.method === 'GET') {
    const payload = JSON.stringify({
      status: migrationState.error ? 'degraded' : 'healthy',
...
healthServer.listen(HEALTH_PORT, () => {
  logger.info({ port: HEALTH_PORT }, 'Migration service health endpoint ready');
});
