...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/heady-max-potential-v40/services/nats-consumers/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
const HEALTH_PORT = parseInt(process.env.PORT || '4040', 10);
const manager = new NATSConsumerManager();

const healthServer = createServer((req, res) => {
  if (req.url === '/health' && req.method === 'GET') {
    const stats = manager.stats;
    const payload = JSON.stringify({
      status: stats.running ? 'healthy' : 'stopped',
      service: 'nats-consumers',
...
healthServer.listen(HEALTH_PORT, () => {
  logger.info({ port: HEALTH_PORT }, 'NATS consumers health endpoint ready');
});
