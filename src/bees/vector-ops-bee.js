...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/bees/vector-ops-bee.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
"use strict";
...
const HEADY_DOMAINS = ["headyme.com", "headybuddy.org", "headysystems.com", "headyconnection.org", "headymcp.com", "headyio.com", "headybot.com", "headyos.com", "headyapi.com", "heady-ai.com", "headylens.com", "headyex.com", "headyfinance.com", "headyconnection.com", "perfecttrader.com", "headyai.me"];
...
function getWork(ctx = {}) {
  ...
  work.push(async () => {
    const res = await safeFetch(`${MANAGER_URL}/api/vector-ops/sprawl-check`, {
      method: "POST"
    });
    return {
      bee: domain,
  ...
  work.push(async () => {
    const res = await safeFetch(`${MANAGER_URL}/api/vector-ops/security-scan`, {
      method: "POST"
    });
    return {
      bee: domain,
  ...
  work.push(async () => {
    const res = await safeFetch(`${MANAGER_URL}/api/vector-ops/compact`, {
      method: "POST"
    });
    return {
      bee: domain,
  ...
  work.push(async () => {
    ...
    return {
      bee: domain,
      action: "pre-deploy-gate",
      deploymentAllowed: clear,
      blockers,
      warnings,
      message: clear ? "Vector space clear — deployment allowed if needed" : `BLOCKED: ${blockers} blocker(s), ${warnings} warning(s)`
    };
  });
