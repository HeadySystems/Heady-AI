 ...
 * heady-notebooklm (733), monte-carlo (578), openai-business, realtime-intelligence,
...
function getWork(ctx = {}) {
    const services = [
        ...
        'heady-autonomy', 'heady-branded-output', 'heady-notebooklm',
