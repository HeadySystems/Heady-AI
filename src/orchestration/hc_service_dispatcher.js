...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/orchestration/hc_service_dispatcher.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
const SERVICE_CATALOG = {
  ...
  chat: {
    ...
    method: "POST",
    caps: ["inference", "reasoning", "conversation"],
    component: "brain"
  },
  analyze: {
    endpoint: "/api/brain/analyze",
    method: "POST",
    caps: ["code-analysis", "text-analysis", "security"],
    component: "brain"
  },
  embed: {
    endpoint: "/api/brain/embed",
    method: "POST",
    caps: ["embedding", "vector", "semantic-search"],
    component: "brain"
  },
  search: {
    endpoint: "/api/brain/search",
    method: "POST",
    caps: ["knowledge-search", "semantic-retrieval"],
    component: "brain"
  },
  jules: {
    endpoint: "/api/headyjules/chat",
    method: "POST",
    caps: ["deep-reasoning", "architecture", "thinking"],
    component: "brain"
  },
  compute: {
    endpoint: "/api/headycompute/chat",
    method: "POST",
    caps: ["general-ai", "function-calling"],
    component: "brain"
  },
  pythia: {
    endpoint: "/api/headypythia/generate",
    method: "POST",
    caps: ["multimodal", "vision", "generation"],
    component: "brain"
  },
  fast: {
    endpoint: "/api/groq/chat",
    method: "POST",
    caps: ["ultra-fast", "low-latency", "quick-response"],
    component: "brain"
  },
  coder: {
    endpoint: "/api/coder/generate",
    method: "POST",
    caps: ["code-generation", "scaffold", "orchestrate"],
    component: "brain"
  },
  codex: {
    endpoint: "/api/codex/generate",
    method: "POST",
    caps: ["code-transform", "documentation"],
    component: "brain"
  },
  copilot: {
    endpoint: "/api/copilot/suggest",
    method: "POST",
    caps: ["inline-suggest", "completion", "context-aware"],
    component: "brain"
  },
  // ─── Core Engines ────────────────────────────────────────────────
  soul: {
    endpoint: "/api/soul/analyze",
    method: "POST",
    caps: ["reflection", "introspection", "quality-eval"],
    component: "soul"
  },
  battle: {
    endpoint: "/api/battle/session",
    method: "POST",
    caps: ["competition", "ranking", "multi-model-eval"],
    component: "battle"
  },
  patterns: {
    endpoint: "/api/patterns/analyze",
    method: "POST",
    caps: ["pattern-detection", "code-analysis", "design"],
    component: "patterns"
  },
  risks: {
    endpoint: "/api/risks/assess",
    method: "POST",
    caps: ["vulnerability-scan", "risk-assessment", "security"],
    component: "patterns"
  },
  vinci: {
    endpoint: "/api/vinci/predict",
    method: "POST",
    caps: ["prediction", "creative-learning", "recognition"],
    component: "vinci"
  },
  lens: {
    endpoint: "/api/lens/analyze",
    method: "POST",
    caps: ["visual-analysis", "image-processing", "detection"],
    component: "lens"
  },
  memory: {
    endpoint: "/api/memory/search",
    method: "POST",
    caps: ["vector-search", "3d-memory", "context-recall"],
    component: "brain"
  },
  // ─── Operations & Maintenance ───────────────────────────────────
  ops: {
    endpoint: "/api/ops/deploy",
    method: "POST",
    caps: ["deployment", "infrastructure", "devops"],
    component: "ops"
  },
  maid: {
    endpoint: "/api/maid/clean",
    method: "POST",
    caps: ["cleanup", "housekeeping", "scheduling"],
    component: "maintenance"
  },
  maintenance: {
    endpoint: "/api/maintenance/status",
    method: "GET",
    caps: ["health-monitoring", "backup", "restore"],
    component: "maintenance"
  },
  // ─── Integrations ───────────────────────────────────────────────
  notion: {
    endpoint: "/api/notebooklm/sync",
    method: "POST",
    caps: ["knowledge-sync", "documentation", "notebooks"],
    component: "notebooklm"
  },
  edge: {
    endpoint: "/api/edge/chat",
    method: "POST",
    caps: ["edge-inference", "edge-embed", "low-latency"],
    component: "cloud"
  },
  buddy: {
    endpoint: "/api/buddy/chat",
    method: "POST",
    caps: ["personal-assist", "multi-provider", "memory"],
    component: "buddy"
  },
  research: {
    endpoint: "/api/perplexity/research",
    method: "POST",
    caps: ["deep-research", "web-search", "academic"],
    component: "brain"
  },
  huggingface: {
    endpoint: "/api/headyhub/model",
    method: "POST",
    caps: ["model-search", "model-info", "inference"],
    component: "brain"
  },
  orchestrator: {
    endpoint: "/api/orchestrator/send",
    method: "POST",
    caps: ["task-routing", "wavelength-align", "coordination"],
    component: "conductor"
  },
  // ─── Pipeline & System ──────────────────────────────────────────
  "auto-flow": {
    endpoint: "/api/hcfp/auto-flow",
    method: "POST",
    caps: ["pipeline", "parallel-processing", "auto-success"],
    component: "auto-success"
  },
  "deep-scan": {
    endpoint: "/api/edge/deep-scan",
    method: "POST",
    caps: ["project-mapping", "deep-analysis", "context"],
    component: "brain"
  },
  "auto-success": {
    endpoint: "/api/auto-success/status",
    method: "GET",
    caps: ["engine-status", "task-cycling", "optimization"],
    component: "auto-success"
  },
  health: {
    endpoint: "/api/health",
    method: "GET",
    caps: ["health-check", "system-status", "uptime"],
    component: "conductor"
  },
  liquid: {
    endpoint: "/api/liquid/state",
    method: "GET",
    caps: ["allocation-state", "flow-tracking", "context-route"],
    component: "conductor"
  },
  scientist: {
    endpoint: "/api/scientist/status",
    method: "GET",
    caps: ["integrity-check", "determinism", "drift-detection"],
    component: "conductor"
  },
  qa: {
    endpoint: "/api/qa/status",
    method: "GET",
    caps: ["quality-assurance", "endpoint-probing", "validation"],
    component: "conductor"
  },
  // ─── DAW / MIDI / Spatial ───────────────────────────────────────
  daw: {
    endpoint: "/api/daw/bridge",
    method: "POST",
    caps: ["midi-bridge", "daw-control", "audio-data-transfer", "osc-transport"],
    component: "creative"
  },
  midi: {
    endpoint: "/api/daw/midi",
    method: "POST",
    caps: ["midi-to-data", "midi-transform", "note-mapping", "cc-routing"],
    component: "creative"
  },
  spatial: {
    endpoint: "/api/spatial/context",
    method: "POST",
    caps: ["spatial-context", "3d-position", "audio-spatial", "ump-transport"],
    component: "deep-intel"
  }
};
  ...
  async dispatch(request = {}) {
    ...
    try {
      ...
      const headers = {
        ...
        "X-Heady-Source": "service-dispatcher"
      };
      let result;
      if (resolved.entry.method === "GET") {
        ...
        const body = {
          ...params,
          source: "heady-service-dispatcher"
        };
        // Map common fields
...
function registerServiceRoutes(app, dispatcher) {
  app.get("/api/service/health", (req, res) => {
    res.json({
      ok: true,
      ...dispatcher.getHealth()
    });
  });
  app.get("/api/service/catalog", (req, res) => {
    res.json({
      ok: true,
      services: dispatcher.getCatalog()
    });
  });
  app.get("/api/service/history", (req, res) => {
    ...
    res.json({
      ok: true,
      history: dispatcher.getHistory(limit),
      total: dispatcher.totalDispatches
    });
  });
