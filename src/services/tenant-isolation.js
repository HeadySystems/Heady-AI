...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/services/tenant-isolation.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
// --- Auto-Unified Latent Service Pattern (wired to TenantIsolation) ---
const _tenantInstance = new TenantIsolation();
module.exports.start = async () => ({ status: 'started', service: 'tenant-isolation' });
module.exports.stop = async () => ({ status: 'stopped', service: 'tenant-isolation' });
module.exports.health = () => _tenantInstance.health();
module.exports.metrics = () => ({
  cachedTenants: _tenantInstance._cache.size,
  activeRateWindows: _tenantInstance._rateWindows.size,
});
