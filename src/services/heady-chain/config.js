...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/services/heady-chain/config.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const config = {
  ...
  CHECKPOINT_TTL_MS: parseInt(process.env.CHECKPOINT_TTL_MS || '86400000', 10),
  // 24h
  ...
  // Human-in-the-loop
  HUMAN_TIMEOUT_MS: parseInt(process.env.HUMAN_TIMEOUT_MS || '3600000', 10),
  // 1h
