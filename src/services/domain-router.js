...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/services/domain-router.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
const DOMAIN_PROJECTIONS = {
  ...
  'headysystems.com': {
    uiId: 'systems-landing',
    module: 'SystemsLanding',
    category: 'corporate'
  },
  ...
  'ai.headyme.com': {
    uiId: 'ai-playground',
    module: 'ModelPlayground',
    category: 'ai'
  },
  // API / Edge
  'heady.headyme.com': {
    uiId: 'antigravity',
    module: 'Antigravity3D',
    category: 'edge'
  },
  'api.headyme.com': {
    uiId: 'api-docs',
...
function registerDomain(hostname, uiId, module, category = 'custom') {
  DOMAIN_PROJECTIONS[hostname.toLowerCase()] = {
    uiId,
    module,
    category
  };
  ...
  app.post('/api/domains/register', (req, res) => {
    ...
    if (!hostname || !uiId || !module) {
      return res.status(400).json({
        error: 'hostname, uiId, and module required'
      });
    }
