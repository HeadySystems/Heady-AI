...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/services/cloud-midi-sequencer.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const {
  ...
  phiScale,
  phiTiming
} = require('../shared/heady-principles');
...
class Pattern {
  ...
  getEventsInRange(startTick, endTick) {
    ...
    return this.events.filter(e => e.tick >= startTick && e.tick < endTick).map(e => ({
      ...e,
      data: [...e.data],
...
class CloudSequencer {
  ...
  registerClient(clientId, latencyMs = 0) {
    this.clients.set(clientId, {
      id: clientId,
      latencyMs,
      offsetMs: latencyMs * PHI_INV,
      // φ-compensated offset
