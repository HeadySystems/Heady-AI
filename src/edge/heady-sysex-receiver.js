...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/edge/heady-sysex-receiver.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
function sysex() {
  ...
  switch (command) {
    case 0x01:
      handleSetTempo(payload);
      break;
    case 0x02:
      handleSetTrackVolume(payload);
      break;
    case 0x03:
      handleTriggerClip(payload);
      break;
    case 0x04:
      handleSetDeviceParam(payload);
      break;
    case 0x05:
...
function handleSetDeviceParam(payload) {
  ...
  try {
    var api = new LiveAPI('live_set tracks ' + trackIdx + ' devices ' + deviceIdx + ' parameters ' + paramIdx);
    api.set('value', value);
    outlet(3, 'param_set', 'track:' + trackIdx, 'dev:' + deviceIdx, 'param:' + paramIdx, 'val:' + value.toFixed(3));
  } catch (e) {
