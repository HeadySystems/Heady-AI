...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/latent/embedding-provider.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
class EmbeddingProvider {
  constructor(options = {}) {
    ...
    this.backendOrder = options.backendOrder || [Backend.CLOUDFLARE, Backend.OPENAI, Backend.LOCAL];
    ...
    for (const backend of this.backendOrder) {
      try {
        ...
        if (backend === Backend.CLOUDFLARE) {
          result = await withRetry(() => embedViaCloudflare(texts, this.config.cloudflare), this.retries, this.retryDelayMs);
        } else if (backend === Backend.OPENAI) {
          result = await withRetry(() => embedViaOpenAI(texts, this.config.openai), this.retries, this.retryDelayMs);
        } else {
