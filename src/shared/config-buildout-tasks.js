...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/shared/config-buildout-tasks.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
{
  id: "cfg-001",
  name: "Wire access-points.yaml to service discovery",
  cat: "architecture",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-002",
  name: "Wire activation-manifest.yaml to startup sequencer",
  cat: "architecture",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-003",
  name: "Wire app-readiness.yaml health gate",
  cat: "architecture",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-004",
  name: "Wire agentic-coding.yaml to code governance",
  cat: "governance",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-005",
  name: "Wire automation-policy.yaml to pipeline engine",
  cat: "governance",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-006",
  name: "Wire ai-services.yaml model registry",
  cat: "ml",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-007",
  name: "Wire brain-profiles.yaml to BuddyCore",
  cat: "intelligence",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-008",
  name: "Wire heady-brain-dominance.yaml strategy",
  cat: "intelligence",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-009",
  name: "Wire heady-intelligence.yaml to deep-intel",
  cat: "intelligence",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-010",
  name: "Wire imagination-engine.yaml creative pipeline",
  cat: "creative",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-011",
  name: "Wire concepts-index.yaml knowledge base",
  cat: "intelligence",
  pool: "cold",
  w: 3,
...
{
  id: "cfg-012",
  name: "Wire auto-deploy.yaml to CI/CD pipeline",
  cat: "devops",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-013",
  name: "Wire cloud-environments.yaml multi-env",
  cat: "devops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-014",
  name: "Wire cloud-first-pipeline.yaml build stages",
  cat: "devops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-015",
  name: "Wire cloud-layers.yaml compute tiers",
  cat: "devops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-016",
  name: "Wire deployment-strategy.yaml rollout config",
  cat: "devops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-017",
  name: "Wire deployment.yaml target manifest",
  cat: "devops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-018",
  name: "Wire build-playbook.yaml build orchestration",
  cat: "devops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-019",
  name: "Wire notebook-ci.yaml notebook validation",
  cat: "devops",
  pool: "cold",
  w: 2,
...
{
  id: "cfg-020",
  name: "Wire branded-domains.yaml to edge proxy",
  cat: "edge-routing",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-021",
  name: "Wire clean-domains.yaml domain audit",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-022",
  name: "Wire cloudflare-dns.yaml DNS automation",
  cat: "edge-routing",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-023",
  name: "Wire domain-architecture.yaml zone structure",
  cat: "edge-routing",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-024",
  name: "Wire domain-mappings.yaml routing table",
  cat: "edge-routing",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-025",
  name: "Wire heady-com-domains.yaml .com routing",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-026",
  name: "Wire heady-domains-final.yaml canonical list",
  cat: "edge-routing",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-027",
  name: "Wire hfcp-domains.yaml HuggingFace domains",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-028",
  name: "Wire minimal-domains.yaml MVP routing",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-029",
  name: "Wire universal-domains.yaml cross-platform routing",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
...
{
  id: "cfg-030",
  name: "Wire cloudflared-config.yaml tunnel setup",
  cat: "devops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-031",
  name: "Wire cmd-center-cloudflared.yaml command center",
  cat: "devops",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-032",
  name: "Wire cmd-center-compose.yaml Docker compose",
  cat: "devops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-033",
  name: "Wire cmd-center-litellm.yaml AI proxy",
  cat: "ml",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-034",
  name: "Wire vm-headyconnection.yaml VM bridge",
  cat: "devops",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-035",
  name: "Wire heady-vm-migration.yml migration plan",
  cat: "devops",
  pool: "cold",
  w: 2,
...
{
  id: "cfg-036",
  name: "Wire auto-monitoring.yaml alerting rules",
  cat: "monitoring",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-037",
  name: "Wire observability.yaml telemetry config",
  cat: "telemetry",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-038",
  name: "Wire slo-latency.yaml SLO thresholds",
  cat: "monitoring",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-039",
  name: "Wire worker-alerts.yaml alert routing",
  cat: "monitoring",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-040",
  name: "Wire connection-integrity.yaml health checks",
  cat: "monitoring",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-041",
  name: "Wire system-self-awareness.yaml metacognition",
  cat: "intelligence",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-042",
  name: "Wire auto-pipeline.yaml pipeline definition",
  cat: "ops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-043",
  name: "Wire hcfullpipeline-config.yaml overrides",
  cat: "ops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-044",
  name: "Wire pipeline.yaml stage ordering",
  cat: "ops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-045",
  name: "Wire priority-tasks.yaml task priority queue",
  cat: "ops",
  pool: "hot",
  w: 5,
...
{
  id: "cfg-046",
  name: "Wire heady-auto-ide.yaml IDE configuration",
  cat: "development",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-047",
  name: "Wire heady-battle.yaml arena config",
  cat: "enterprise",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-048",
  name: "Wire headybrowser-config.yaml browser settings",
  cat: "development",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-049",
  name: "Wire heady-browser.yaml browser automation",
  cat: "development",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-050",
  name: "Wire heady-buddy.yaml buddy personality",
  cat: "enterprise",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-051",
  name: "Wire heady-buddy-always-on.yaml persistence",
  cat: "enterprise",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-052",
  name: "Wire headybuddy-config.yaml runtime settings",
  cat: "enterprise",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-053",
  name: "Wire heady-coder.yaml coding agent config",
  cat: "development",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-054",
  name: "Wire resource-allocation.yaml compute limits",
  cat: "ops",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-055",
  name: "Wire resource-diagnostics.yaml diagnostic rules",
  cat: "ops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-056",
  name: "Wire resource-management-protocol.yaml policy",
  cat: "ops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-057",
  name: "Wire resource-policies.yaml guardrails",
  cat: "ops",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-058",
  name: "Wire resource-rules.yaml enforcement",
  cat: "ops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-059",
  name: "Wire resource-thresholds.yaml alert triggers",
  cat: "monitoring",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-060",
  name: "Wire dynamic-parallel-resource-allocation.yaml",
  cat: "ops",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-061",
  name: "Wire service-catalog.yaml service registry",
  cat: "architecture",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-062",
  name: "Wire service-contracts.yaml API contracts",
  cat: "architecture",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-063",
  name: "Wire service-discovery.yaml mesh discovery",
  cat: "architecture",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-064",
  name: "Wire service-domains.yaml domain ownership",
  cat: "architecture",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-065",
  name: "Wire site-registry.yaml site configuration",
  cat: "architecture",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-066",
  name: "Wire skills-registry.yaml skill catalog",
  cat: "intelligence",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-067",
  name: "Wire foundation-contract.yaml system contract",
  cat: "governance",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-068",
  name: "Wire founder-intent-policy.yaml intent rules",
  cat: "governance",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-069",
  name: "Wire naming-standards.yaml enforcement",
  cat: "governance",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-070",
  name: "Wire ip-registry.yaml IP protection",
  cat: "governance",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-071",
  name: "Wire iterative-rebuild-directive.yaml rebuild",
  cat: "governance",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-072",
  name: "Wire speed-and-patterns-protocol.yaml performance",
  cat: "governance",
  pool: "warm",
  w: 4,
...
{
  id: "cfg-073",
  name: "Wire extension-pricing.yaml revenue config",
  cat: "enterprise",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-074",
  name: "Wire provider-budgets.yaml cost governance",
  cat: "enterprise",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-075",
  name: "Wire product-repos.yaml repo registry",
  cat: "architecture",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-076",
  name: "Wire public-domain-integration.yaml public API",
  cat: "edge-routing",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-077",
  name: "Wire website-definitions.yaml site configs",
  cat: "presentation",
  pool: "warm",
  w: 3,
...
{
  id: "cfg-078",
  name: "Wire system-components.yaml inventory",
  cat: "architecture",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-079",
  name: "Wire data-schema.yaml persistence schema",
  cat: "database",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-080",
  name: "Wire device-management.yaml device registry",
  cat: "enterprise",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-081",
  name: "Wire functional-domains.yaml DDD boundaries",
  cat: "architecture",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-082",
  name: "Wire monte-carlo-scheduler.yaml MC config",
  cat: "intelligence",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-083",
  name: "Wire story-driver.yaml narrative engine",
  cat: "creative",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-084",
  name: "Wire vr-overlay.yaml spatial computing",
  cat: "creative",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-085",
  name: "Wire ascii-art-templates.yaml branding",
  cat: "presentation",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-086",
  name: "Wire file_metadata_template.yaml linting",
  cat: "governance",
  pool: "cold",
  w: 2,
  ...
  id: "cfg-087",
  name: "Wire mcp-vertical-spec.yaml vertical MCP",
  cat: "mcp",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-088",
  name: "Wire heady-ide.yaml IDE extension manifest",
  cat: "development",
  pool: "warm",
  w: 3,
...
{
  id: "cfg-089",
  name: "Wire 0.0.0.0-elimination-protocol.yaml prod",
  cat: "devops",
  pool: "warm",
  w: 4,
  desc: "Load configs/0.0.0.0-elimination-protocol.yaml, block any 0.0.0.0 references in prod"
}, {
  id: "cfg-090",
  name: "Wire secrets-manifest.yaml key management",
  cat: "security",
  pool: "hot",
  w: 5,
  ...
  id: "cfg-091",
  name: "Wire auto-deploy-config.json deploy targets",
  cat: "devops",
  pool: "warm",
  w: 3,
  ...
  id: "cfg-092",
  name: "Wire domain-registry.json DNS source of truth",
  cat: "edge-routing",
  pool: "warm",
  w: 4,
  ...
  id: "cfg-093",
  name: "Wire headymcp.json MCP server manifest",
  cat: "mcp",
  pool: "warm",
  w: 4,
