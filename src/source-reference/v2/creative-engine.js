...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/source-reference/v2/creative-engine.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
class CreativeEngine {
  ...
  async generate(prompt, style = STYLES.PROSE, opts = {}) {
    ...
    try {
      ...
      logger.error('[CreativeEngine] generation failed', {
        style,
        err: err.message
      });
      throw err;
  ...
  registerTemplate(name, template) {
    ...
    logger.debug('[CreativeEngine] template registered', {
      name
    });
    return this;
  }
  ...
  async generateVariations(prompt, style = STYLES.PROSE, opts = {}) {
    ...
    const promises = Array.from({
      length: count
    }, () => this.generate(prompt, style, {
      ...generateOpts,
      temperature: (generateOpts.temperature ?? 0.7) + (Math.random() * 0.2 - 0.1)
    }));
