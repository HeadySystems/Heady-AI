...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/source-reference/v2/sync-projection-bee.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
    ...
    for (const [domainName, spaceName] of Object.entries(domainToSpace)) {
      ...
      if (!template) {
        results.push({
          space: spaceName,
          injected: false,
          reason: `No template for ${domainName}`
        });
        continue;
      }
      ...
      if (!rendered) {
        results.push({
          space: spaceName,
          injected: false,
          reason: "renderSite returned null"
        });
        continue;
      }
...
function projectToGitHub(changedFiles) {
  try {
    ...
    execSync(`git commit -m "[sync-projection] auto-inject templates ${ts}" --allow-empty`, {
      cwd: PROJECT_ROOT
    });
