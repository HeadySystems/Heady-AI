...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/hcfp/task-dispatcher.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
function classify(task) {
  ...
  if (task.service_group && task.service_group !== "brain") {
    const agentKey = Object.keys(SUB_AGENTS).find(key => key === task.service_group || SUB_AGENTS[key].name.toLowerCase() === task.service_group.toLowerCase());
    if (agentKey) {
  ...
  const searchText = [task.name || "", task.action || "", JSON.stringify(task.inputs || {})].join(" ").toLowerCase();
  let bestMatch = null;
  let bestScore = 0;
