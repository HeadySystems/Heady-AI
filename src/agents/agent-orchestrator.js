...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: src/agents/agent-orchestrator.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
class AgentOrchestrator {
  ...
  constructor(opts = {}) {
    ...
    this.taskTimeoutMs = opts.taskTimeoutMs ?? PHI_TIMING.CYCLE;  // φ⁷ × 1000
  ...
  _registerInternal(name, config, persist) {
    ...
    this._breakers.set(name, new CircuitBreaker({
      ...
      recoveryTimeMs: config.recoveryTimeMs ?? PHI_TIMING.CYCLE,  // φ⁷ × 1000
    }));
