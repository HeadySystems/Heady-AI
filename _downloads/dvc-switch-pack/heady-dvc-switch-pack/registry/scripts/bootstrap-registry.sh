...
# ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
# ║  FILE: _downloads/dvc-switch-pack/heady-dvc-switch-pack/registry/scripts/bootstrap-registry.sh                                                    ║
# ║  LAYER: automation                                                  ║
# ╚══════════════════════════════════════════════════════════════════╝
# HEADY_BRAND:END
set -euo pipefail
...
mkdir -p datasets/{core,experiments,synthetic} \
         models/{base,finetuned,legacy} \
         embeddings/{text,vision} \
         artifacts/{renders,logs,checkpoints}
