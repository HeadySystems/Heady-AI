...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: heady-monorepo/src/mcp/mcp-sse-transport.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
const _fetch = globalThis.fetch || ((...args) => { try { return require('node-fetch')(...args); } catch { throw new Error('fetch not available'); } });
...
class McpSseTransport {
    ...
    async _headyPost(path, body, apiKey) {
        const res = await _fetch(`${this.baseUrl}${path}`, {
            method: 'POST',
            headers: {
