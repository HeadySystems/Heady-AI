...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: heady-monorepo/src/bees/auth-provider-bee.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
let AUTH_PROVIDERS = {}, SWARM_TASKS = [];
try {
    ({ AUTH_PROVIDERS, SWARM_TASKS } = require('../../configs/templates/auth-providers-swarm'));
} catch(_e) {
    AUTH_PROVIDERS = {
        google: { name: 'Google', scope: ['openid', 'email', 'profile'] },
        github: { name: 'GitHub', scope: ['read:user', 'user:email'] },
