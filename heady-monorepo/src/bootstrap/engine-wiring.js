...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: heady-monorepo/src/bootstrap/engine-wiring.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
function wireEngines(app, deps = {}) {
    ...
    // ─── 1. Resource Manager ──────────────────────────────────────────
    try {
        const { HCResourceManager, registerRoutes: registerResourceRoutes } = require('../runtime/hc_resource_manager');
    ...
    // ─── 2. Task Scheduler ────────────────────────────────────────────
    try {
        const { HCTaskScheduler, registerSchedulerRoutes } = require('../orchestration/hc_task_scheduler');
    ...
    try {
        const { HCResourceDiagnostics, registerDiagnosticRoutes } = require('../runtime/hc_resource_diagnostics');
    ...
    try {
        const { mcPlanScheduler: _mcPS, mcGlobal: _mcG, registerHeadySimsRoutes } = require('../intelligence/hc_monte_carlo');
    ...
    try {
        const { patternEngine: _pe, registerPatternRoutes } = require('../intelligence/hc_pattern_engine');
    ...
    // ─── 6. Story Driver ──────────────────────────────────────────────
    try {
        const { HCStoryDriver, registerStoryRoutes } = require('../observability/hc_story_driver');
    ...
    try {
        const { selfCritique, registerSelfCritiqueRoutes } = require('../observability/hc_self_critique');
