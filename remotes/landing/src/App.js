...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: remotes/landing/src/App.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/*
...
const APP_CONFIG = {
  id: 'landing',
  title: 'HeadyWeb',
  desc: 'Central Portal — All Heady Apps',
  icon: '🐝',
  color: '#f59e0b',
  version: '3.2.0'
};
...
function createApp(container, props = {}) {
  ...
  root.className = 'mfe-root mfe-landing';
  root.style.cssText = 'min-height:100vh;background:linear-gradient(135deg, #78350f, #92400e);color:#fff;font-family:Inter,system-ui,sans-serif;';

  root.innerHTML = `
    <style>
      .mfe-landing { padding: 0; margin: 0; }
      .mfe-landing .mfe-header { padding: 1.5rem 2rem; border-bottom: 1px solid rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: space-between; backdrop-filter: blur(20px); background: rgba(0,0,0,0.3); }
      .mfe-landing .mfe-header h1 { font-size: 1.4rem; font-weight: 600; margin: 0; display: flex; align-items: center; gap: 0.75rem; }
      .mfe-landing .mfe-header .mfe-badge { font-size: 0.65rem; background: #f59e0b33; color: #f59e0b; padding: 0.25rem 0.75rem; border-radius: 999px; border: 1px solid #f59e0b44; }
      .mfe-landing .mfe-body { padding: 2rem; max-width: 1200px; margin: 0 auto; }
      .mfe-landing .mfe-desc { color: rgba(255,255,255,0.6); font-size: 0.85rem; margin: 0; }
      ...
      .ide-tabs span.active { color: #fff; border-color: #f59e0b; background: rgba(255,255,255,0.05); }
      ...
      .bee-card:hover { border-color: #f59e0b55; transform: translateY(-2px); }
      ...
      .vec-input:focus { border-color: #f59e0b; }
      ...
      .vec-item:hover { border-color: #f59e0b44; background: rgba(0,0,0,0.5); }
      .vec-dist { font-family: monospace; font-size: 0.8rem; color: #f59e0b; min-width: 3rem; }
    ...
    <div class="mfe-body">
      <div class="landing-hero"><h1>🐝 Heady™</h1><p>Autonomous Multi-Agent Platform</p>
      <p class="landing-sub">Maximum Global Happiness through AI-Powered Social Impact</p>
      <div class="landing-apps"><span class="app-chip">Admin</span><span class="app-chip">IDE</span><span class="app-chip">Buddy</span><span class="app-chip">Manager</span><span class="app-chip">MCP</span><span class="app-chip">IO</span><span class="app-chip">Connection</span><span class="app-chip">1ime1</span><span class="app-chip">Canvas</span><span class="app-chip">Systems</span><span class="app-chip">Me</span></div></div>
    </div>
  `;
...
if (typeof window !== 'undefined') window.__HEADY_MFE_LANDING = createApp;
