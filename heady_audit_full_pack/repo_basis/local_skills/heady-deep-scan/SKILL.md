...
<!-- ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
<!-- ║  FILE: heady_audit_full_pack/repo_basis/local_skills/heady-deep-scan/SKILL.md                                                    ║
<!-- ║  LAYER: root                                                  ║
<!-- ╚══════════════════════════════════════════════════════════════════╝
<!-- HEADY_BRAND:END
-->
...
- **Scan once per session** — the results persist in vector memory, no need to re-scan unless files change significantly
- **Specify the project root** — not a subdirectory, so the full context is captured
- **Follow up with `heady_memory`** queries — this confirms the scan loaded properly and lets you explore the codebase
