...
describe('Self-Awareness — System Assessment', () => {
    test('assessSystemState returns confidence and context', async () => {
        const assessment = await assessSystemState('unit test context');
    ...
    test('assessSystemState works without context argument', async () => {
