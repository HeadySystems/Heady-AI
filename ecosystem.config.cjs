...
module.exports = {
    apps: [
        ...
        {
            name: 'heady-auth-service',
            script: 'src/auth/heady-auth-service.js',
            cwd: '/home/headyme/Heady',
            instances: 1,
            exec_mode: 'fork',
            env: {
                NODE_ENV: 'production',
                HEADY_AUTH_PORT: 3847,
                HEADY_AUTH_URL: 'https://headyme.com',
                FIREBASE_PROJECT_ID: 'headyme-444017',
            },
            ...
            restart_delay: 3000,
            watch: false,
            error_file: '/home/headyme/Heady/logs/auth-error.log',
            out_file: '/home/headyme/Heady/logs/auth-out.log',
            merge_logs: true,
            log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
        },
        {
