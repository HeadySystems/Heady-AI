...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: tools/phi-compliance-checker.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
function scanFile(filePath) {
  ...
  try {
    ...
    // Unreadable file — report as warning, not hard failure
    return [{
      file:      filePath,
      line:      0,
      current:   '<unreadable>',
...
/**
 * Calculate compliance score as percentage of violation-free lines.
...
class PhiComplianceChecker {
   ...
   * @param {boolean} [options.verbose]  Print each violation as it's found
