...
var VALID_API_KEYS = /* @__PURE__ */ new Set([
  "heady_api_key_001_abc123def456",
  "heady_api_key_002",
  "heady_api_key_003",
  "heady_api_key_004",
  "heady_api_key_005"
...
var SERVICE_MAP = {
  "manager.headysystems.com": { origin: "https://manager.headysystems.com", mtls: true, public: false },
  "api.headysystems.com": { origin: "https://manager.headysystems.com", mtls: true, public: false },
  "admin.headysystems.com": { origin: "https://manager.headysystems.com", mtls: true, public: false },
  "api.headyme.com": { origin: "https://manager.headysystems.com", mtls: true, public: false },
...
var HEADY_MODEL_GROUPS = {
  fast: {
    ...
    hybridStrategy: "Prefer cloud; fallback to local when cloud latency > 2x local baseline"
  },
  reasoning: {
    ...
    hybridStrategy: "Cloud-first for max reasoning depth; local for offline/edge scenarios"
  },
  creative: {
    ...
    hybridStrategy: "Cloud-first; Grok prioritized for maximum creative freedom"
  },
  code: {
    ...
    hybridStrategy: "Cloud for complex tasks; local Qwen Coder for autocomplete/fast edits"
  },
  vision: {
    ...
    hybridStrategy: "Cloud-first for speed; HF models for specialized vision tasks"
  }
};
      ...
      if (service) {
        ...
        if (requiresMtls) {
          ...
          if (certStatus === "missing" || !certVerified) {
            const apiKeyAuth = authenticateRequest(request);
            if (!apiKeyAuth.ok) {
...
function authenticateRequest(request) {
  ...
  if (!VALID_API_KEYS.has(key)) return { ok: false, reason: "Invalid API key." };
  return { ok: true, key };
}
