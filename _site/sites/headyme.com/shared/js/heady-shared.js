...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: _site/sites/headyme.com/shared/js/heady-shared.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
  ...
  const HeadyAutoContext = {
    ...
    init(siteMeta) {
      ...
      window.addEventListener('message', (event) => {
        ...
        if (event.data?.type === 'heady:auth:sync') {
          ...
          this.broadcast('auth:update', { user: event.data.user });
        }
    ...
    _pingAuth() {
      ...
      if (iframe?.contentWindow) {
        iframe.contentWindow.postMessage({ type: 'heady:context:request', site: this.site?.slug }, 'https://auth.headysystems.com');
      }
    },
