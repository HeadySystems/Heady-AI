...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-arbiter/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-arbiter';
...
api.post('/predict', async (req, res) => {
...
api.post('/drift', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/reconcile', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
