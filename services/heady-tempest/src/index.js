...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-tempest/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-tempest';
...
api.post('/scenario', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
...
api.post('/compare', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/baseline', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
