...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-projection/src/scaffold-cli.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
const err = (msg, exit) => {
  logger.error(`${c.red}✖${c.reset}  ${msg}`);
...
const files = [{
  ...
  content: packageJson(type === 'app')
}, {
  path: join(srcDir, 'index.js'),
  content: srcIndex(type === 'app')
}, {
  path: join(baseDir, 'tsconfig.json'),
  content: tsconfigFor()
}, {
  path: join(baseDir, 'README.md'),
  content: readme(type === 'app')
}];
if (type === 'app') {
  files.push({
