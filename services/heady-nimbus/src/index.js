...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-nimbus/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-nimbus';
...
api.post('/spend', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/waste', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
...
api.post('/allocate', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
