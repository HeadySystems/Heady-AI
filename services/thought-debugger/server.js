...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/thought-debugger/server.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
const server = http.createServer((req, res) => {
  ...
  if (parsed.pathname === '/create' && req.method === 'POST') {
    ...
    req.on('end', () => {
      ...
      const session = createSession(prompt, steps);
...
server.listen(PORT, () => logger.info(`🔬 Thought Debugger on :${PORT}`));
module.exports = {
  createSession
};