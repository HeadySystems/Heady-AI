...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-cartograph/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-cartograph';
...
api.post('/upstream', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/downstream', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/orphans', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
