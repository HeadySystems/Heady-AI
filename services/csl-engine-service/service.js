...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/csl-engine-service/service.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
 ...
 */
import { PSI, FIB, CSL_THRESHOLDS, cosineSimilarity, cslAND, cslOR, cslNOT, cslIMPLY, cslCONSENSUS, cslGate } from '../../shared/phi-math.js';
import { createLogger } from '../../shared/logger.js';
import { CSLErrors } from '../../shared/errors.js';
const logger = createLogger('csl-engine-service');
// ═══ Execute CSL Operation ═══
export function executeCSL(req) {
    ...
    switch (operation) {
        case 'AND': {
            if (vectors.length !== 2)
                throw CSLErrors.operationUndefined('AND requires exactly 2 vectors');
        ...
        case 'OR': {
            if (vectors.length < 2)
                throw CSLErrors.operationUndefined('OR requires at least 2 vectors');
        ...
        case 'NOT': {
            if (vectors.length !== 2)
                throw CSLErrors.operationUndefined('NOT requires exactly 2 vectors');
        ...
        case 'IMPLY': {
            if (vectors.length !== 2)
                throw CSLErrors.operationUndefined('IMPLY requires exactly 2 vectors');
        ...
        case 'XOR': {
            if (vectors.length !== 2)
                throw CSLErrors.operationUndefined('XOR requires exactly 2 vectors');
        ...
        case 'CONSENSUS': {
            if (vectors.length < 2)
                throw CSLErrors.operationUndefined('CONSENSUS requires at least 2 vectors');
        ...
        case 'GATE': {
            if (vectors.length !== 2)
                throw CSLErrors.operationUndefined('GATE requires exactly 2 vectors (input, gate)');
...
export function routeTask(taskEmbedding, nodeCapabilities) {
