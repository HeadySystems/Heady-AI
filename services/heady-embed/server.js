...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-embed/server.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const log = {
  error: (...a) => currentLevel >= 0 && logger.error(JSON.stringify({
    ts: new Date().toISOString(),
    level: 'error',
    msg: a.join(' ')
  })),
  warn: (...a) => currentLevel >= 1 && logger.warn(JSON.stringify({
    ts: new Date().toISOString(),
    level: 'warn',
    msg: a.join(' ')
  })),
  info: (...a) => currentLevel >= 2 && logger.info(JSON.stringify({
    ts: new Date().toISOString(),
    level: 'info',
    msg: a.join(' ')
  })),
  debug: (...a) => currentLevel >= 3 && logger.info(JSON.stringify({
    ts: new Date().toISOString(),
    level: 'debug',
    msg: a.join(' ')
  }))
