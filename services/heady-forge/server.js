...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-forge/server.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
const server = http.createServer((req, res) => {
  ...
  if (parsed.pathname === '/generate' && req.method === 'POST') {
    ...
    req.on('end', () => {
      ...
      const result = generateService(name, description, port, endpoints);
  ...
  res.end(JSON.stringify({
    ...
    version: '1.0.0',
    endpoints: {
      '/generate': 'POST {name, description, port, endpoints}'
    }
  }));
});
const PORT = process.env.PORT || 8131;
server.listen(PORT, () => logger.info(`🔨 HeadyForge on :${PORT}`));
module.exports = {
  generateService
};