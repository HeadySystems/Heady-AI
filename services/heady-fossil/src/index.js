...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-fossil/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-fossil';
...
api.post('/blame-deep', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/decision-trail', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/experts', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/churn', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
