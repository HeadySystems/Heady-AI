...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-hive/morph-engine.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
  ...
  _registerDefaultRoles() {
    this.registerRole('manager', {
      ...
      services: [{
        ...
        name: 'health',
        entry: 'services/heady-health/probe-orchestrator.js'
      }]
    });
    this.registerRole('worker', {
      ...
      services: [{
        name: 'scheduler',
        entry: 'services/heady-orchestration/monte-carlo-scheduler.js'
      }, {
        name: 'pdca',
        entry: 'services/heady-brain/pdca-loop.js'
      }]
    });
    this.registerRole('mcp', {
      ...
      services: [{
        name: 'jit-loader',
        entry: 'services/heady-mcp/jit-tool-loader.js'
      }, {
        name: 'router',
        entry: 'services/heady-mcp/intelligent-router.js'
      }, {
        name: 'discovery',
        entry: 'services/heady-mcp/connector-discovery.js'
      }]
    });
    ...
    this.registerRole('security', {
      ...
      services: [{
        name: 'secrets',
        entry: 'services/heady-security/jit-secrets-manager.js'
      }, {
        name: 'rbac',
        entry: 'services/heady-security/role-enforcer.js'
      }]
    });
