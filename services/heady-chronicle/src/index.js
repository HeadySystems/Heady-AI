...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-chronicle/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE = 'heady-chronicle';
const PORT = process.env.PORT || 3743;
...
api.post('/:action', async (req, res) => {
  ...
  res.json({ status: 'ok', service: SERVICE, action, result: { message: 'Processing via heady-chronicle' } });
});
