...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-onboarding/src/app/api/user/route.ts                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    const response = await fetch(`${process.env.HEADY_API_URL ?? 'https://api.headyapi.com'}/internal/users/me`, {
      headers: {
...
export async function PATCH(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const allowedFields = ['displayName', 'buddyConfig', 'theme', 'runtimeMode', 'emailMode', 'forwardTo', 'voiceEnabled'];
