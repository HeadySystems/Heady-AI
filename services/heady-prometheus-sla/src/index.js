...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-prometheus-sla/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE = 'heady-prometheus-sla';
const PORT = process.env.PORT || 3726;
...
api.post('/:action', async (req, res) => {
  ...
  res.json({ status: 'ok', service: SERVICE, action, result: { message: 'Processing via heady-prometheus-sla' } });
});
