...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-vector/config.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const config = {
  ...
  vectorDimensions: {
    ...
    large: 768,
    // all-mpnet-base-v2, paraphrase-mpnet-base-v2
    default: 384
  },
  ...
  search: {
    ...
    defaultAlpha: parseFloat(process.env.DEFAULT_ALPHA) || 0.7,
    // 0=pure BM25, 1=pure semantic
    rrfK: parseInt(process.env.RRF_K, 10) || 60,
    // RRF constant
    mmrLambda: parseFloat(process.env.MMR_LAMBDA) || 0.5 // MMR diversity vs relevance
  },
  // Batch operations
  batch: {
    upsertSize: parseInt(process.env.BATCH_UPSERT_SIZE, 10) || Math.round(PHI * PHI * 100),
    // ~261
...
if (Math.abs(weightSum - 1.0) > 0.01) {
  logger.warn(`[heady-vector] WARNING: BM25_WEIGHT(${config.search.bm25Weight}) + SEMANTIC_WEIGHT(${config.search.semanticWeight}) = ${weightSum} (should be 1.0)`);
}
