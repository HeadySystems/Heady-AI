...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-cadence/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-cadence';
...
api.post('/prepare', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/changelog', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/gate', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/ship', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
