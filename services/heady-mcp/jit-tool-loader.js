...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-mcp/jit-tool-loader.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
...
class JITToolLoader {
  ...
  matchTools(intent) {
    ...
    for (const [name, def] of this.registry) {
      let score = 0;
      const allKeywords = [...def.keywords, ...def.description.toLowerCase().split(/\s+/), def.category, name];
...
function createDefaultLoader() {
  ...
  const defaultTools = [{
    name: 'chat',
    description: 'Conversational AI chat with multi-model routing',
    category: 'communication',
    keywords: ['talk', 'ask', 'question', 'chat', 'discuss']
  }, {
    name: 'code-generate',
    description: 'Generate code from natural language description',
    category: 'development',
    keywords: ['code', 'write', 'function', 'implement', 'create']
  }, {
    name: 'code-review',
    description: 'Review and analyze code for issues',
    category: 'development',
    keywords: ['review', 'analyze', 'check', 'lint', 'quality']
  }, {
    name: 'code-refactor',
    ...
    category: 'research',
    keywords: ['search', 'find', 'lookup', 'web', 'google']
  }, {
    name: 'embed',
    description: 'Generate vector embeddings from text',
    category: 'memory',
    keywords: ['embed', 'vector', 'embedding', 'encode']
  }, {
    name: 'memory-read',
    description: 'Read from vector memory store',
    category: 'memory',
    keywords: ['remember', 'recall', 'memory', 'read', 'retrieve']
  }, {
    name: 'memory-write',
    description: 'Write to vector memory store',
    category: 'memory',
    keywords: ['store', 'save', 'memory', 'write', 'persist']
  }, {
    name: 'deploy',
    description: 'Deploy services to cloud infrastructure',
    category: 'operations',
    keywords: ['deploy', 'ship', 'release', 'publish']
  }, {
    name: 'health-check',
    description: 'Check service health across all domains',
    category: 'operations',
    keywords: ['health', 'status', 'check', 'monitor', 'probe']
  }, {
    name: 'git-ops',
    ...
    name: 'database',
    description: 'Database operations - query, migrate, backup',
    category: 'data',
    keywords: ['database', 'sql', 'query', 'migrate', 'backup']
  }, {
    name: 'agent-spawn',
    description: 'Spawn specialized AI agent workers',
    category: 'orchestration',
    keywords: ['agent', 'spawn', 'worker', 'bee', 'swarm']
  }, {
    name: 'arena-race',
    description: 'Race multiple AI models for best answer',
    category: 'orchestration',
    keywords: ['arena', 'race', 'battle', 'compare', 'compete']
  }, {
    name: 'monte-carlo',
    description: 'Monte Carlo simulation for decision making',
    category: 'orchestration',
    keywords: ['simulate', 'monte', 'carlo', 'probability']
  }, {
    name: 'security-scan',
...
if (require.main === module) {
  ...
  if (args.includes('--benchmark')) {
    ...
    const intents = ['deploy my code to cloud run', 'search for kubernetes best practices', 'check the health of all services', 'generate a React component for user login', 'remember this conversation for later'];
