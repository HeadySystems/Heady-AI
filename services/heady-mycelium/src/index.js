...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-mycelium/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-mycelium';
...
api.post('/trace', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/topology', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/hotspot', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
