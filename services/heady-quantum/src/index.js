...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: services/heady-quantum/src/index.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
const SERVICE_NAME = 'heady-quantum';
...
api.post('/bayesian', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/decide', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});

api.post('/risk', async (req, res) => {
  res.json({ status: 'ok', result: {} });
});
