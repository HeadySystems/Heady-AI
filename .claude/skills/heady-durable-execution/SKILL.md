...
description: "Use when implementing crash-proof, long-running orchestration with replay/checkpointing and human-in-the-loop gates in the Heady ecosystem. Durable execution runs on Cloudflare Workflows + Queues + Durable Objects (ADR-0004) — NOT Temporal. Keywords: durable execution, Cloudflare Workflows, workflow step, queue, Durable Object, replay, checkpoint, crash recovery, long-running, human-in-the-loop, rollback, idempotency."
---
