...
<!-- ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
<!-- ║  FILE: dropzone/06-Skills-Library/heady-coding-standards-SKILL.md                                                    ║
<!-- ║  LAYER: root                                                  ║
<!-- ╚══════════════════════════════════════════════════════════════════╝
<!-- HEADY_BRAND:END
-->
...
10. **PINNED DEPENDENCIES** — All package versions are pinned to exact versions (no `^` or `~`). Run `pnpm audit` / `pip audit` on every build.
...
- Never require `pnpm run build` or `webpack` for a UI to function
