...
description: "Forensic Analyst for Heady — deep investigation tool for debugging system failures, tracing data corruption, analyzing security incidents, dissecting performance regressions, and conducting post-mortems across the Heady ecosystem. Combines code analysis, log investigation, git history forensics, connected app data (GitHub issues/PRs, Slack discussions), and web research for known issues into comprehensive root-cause analyses. Use when something breaks in the Heady ecosystem, performance degrades, data looks wrong, a security concern surfaces, or Eric needs to understand why something happened. Keywords: forensic, investigation, debug, root cause, post-mortem, incident, regression, performance, security incident, log analysis, git blame, trace, corruption, failure analysis, Heady debugging."
---
...
<!-- ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
<!-- ║  FILE: dropzone/06-Skills-Library/34-heady-forensic-analyst.md                                                    ║
<!-- ║  LAYER: root                                                  ║
<!-- ╚══════════════════════════════════════════════════════════════════╝
<!-- HEADY_BRAND:END
-->
