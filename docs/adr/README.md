...
- `0031` — Solo-Founder Approval-System Bootstrap. This proposal does not activate a genesis
  exception or change HCP quorum until explicitly accepted through its stage-0 procedure.
