...
class HeadyBrain:
    ...
    def _assign_tasks(self, request: str, concepts: List[str]) -> List[Dict[str, Any]]:
        ...
        concept_task_map = {
            "deployment": {"action": "deploy", "target": "system", "confidence": "high"},
            "monitoring": {"action": "monitor", "target": "services", "confidence": "medium"},
            "security": {"action": "audit", "target": "security", "confidence": "high"},
            "optimization": {"action": "optimize", "target": "performance", "confidence": "medium"},
            "documentation": {"action": "document", "target": "code", "confidence": "low"}
        }
