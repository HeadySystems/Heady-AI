...
<!-- ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
<!-- ║  FILE: dropzone/02-AI-Prompts/perplexity/model-racing-prompts/10-patent-ip-auto-documentation.md                                                    ║
<!-- ║  LAYER: root                                                  ║
<!-- ╚══════════════════════════════════════════════════════════════════╝
<!-- HEADY_BRAND:END
-->
# Heady™ Patent Concept Registry + IP Protection + Auto-Documentation
...
## Objective
CSL-gated innovation scoring, MC-based prior art detection, deterministic documentation generation. Auto-evaluate new code patterns for patentability.

## Specific Deliverables — Build ALL Files
### 1. Patent Registry — CSL-scored concept registration, phi-weighted novelty/utility/non-obviousness
### 2. Patent Bee — auto-detect novel patterns, CSL similarity threshold at φ⁻¹
### 3. Prior Art Detection — MC sampling against registry, CSL uniqueness confidence
### 4. Auto-Documentation — patent-quality descriptions from code, deterministic hash matching
### 5. Test Suite — novelty scoring, detection accuracy, MC sampling, doc determinism, CSL thresholds

## Constraints
- φ = 1.6180339887, SHA-256, Node.js, temp=0 seed=42
...
### `src/shared/patent-concept-registry.js`
