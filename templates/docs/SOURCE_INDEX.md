...
<!-- ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
<!-- ║  FILE: templates/docs/SOURCE_INDEX.md                                                    ║
<!-- ║  LAYER: docs                                                  ║
<!-- ╚══════════════════════════════════════════════════════════════════╝
<!-- HEADY_BRAND:END
-->
...
This pack was synthesized from the following public repositories and scanned paths.
...
## Primary scanned paths in the main repo
...
- `configs/heady.config.yaml`
- `configs/observability/observability.yaml`
- `configs/resources/performance-budgets.yaml`
- `package.json`

## Thin projected repo comparison points

- `headyme-core/index.js`
- `headyme-core/site-config.json`
- `headymcp-core/index.js`
- `headymcp-core/site-config.json`
- `headysystems-core/index.js`
- `headysystems-core/site-config.json`
