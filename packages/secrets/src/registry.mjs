...
export const SECRETS = Object.freeze([
  ...
  { name: "NEON_API_KEY", required: false, secret: true, minLength: 20,
    rotation: { strategy: "provider", maxAgeDays: FIB[9] }, description: "Neon platform API key (api.neon.tech) for management ops — project/branch/role admin; consumed by src/services/neon-db.js. Distinct from DATABASE_URL (the connection string)." },
