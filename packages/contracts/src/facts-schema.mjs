...
//      event_bus, agent_harness, stage_count=22 per ADR-0040). ADR-cited.
...
export const FACTS_V1 = [
  ...
  { path: "hcfullpipeline.stage_count", required: true, const: 22, adr: "ADR-0040 — 22-stage HCFP DAG, DISTILL terminal (superseded the 21=fib(8) canon 2026-08-04)" },
