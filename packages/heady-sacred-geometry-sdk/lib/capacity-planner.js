...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: packages/heady-sacred-geometry-sdk/lib/capacity-planner.js                                                    ║
// ║  LAYER: root                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
/**
...
class CapacityPlanner {
  ...
  allocate(primaryId, secondaryId, totalBudget) {
    ...
    const allocation = {
      primary: {
        id: primaryId,
        budget: Math.round(split.major)
      },
      secondary: {
        id: secondaryId,
        budget: Math.round(totalBudget - split.major)
      },
