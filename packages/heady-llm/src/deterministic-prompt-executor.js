...
// ║  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  ║
// ║  FILE: packages/heady-llm/src/deterministic-prompt-executor.js                                                    ║
// ║  LAYER: backend/src                                                  ║
// ╚══════════════════════════════════════════════════════════════════╝
// HEADY_BRAND:END
'use strict';
...
class DeterministicPromptExecutor {
  ...
  execute(promptId, vars = {}, opts = {}) {
    ...
    let interpolated;
    try {
      interpolated = this.promptManager.interpolate(promptId, vars, {
        strict
      });
    } catch (err) {
      const haltResult = {
  ...
  getDeterminismReport() {
    ...
    const hitRate = this._stats.totalExecutions > 0 ? (this._stats.cacheHits / this._stats.totalExecutions * 100).toFixed(1) : '0.0';
    return {
